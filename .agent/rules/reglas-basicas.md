...
3 Al abrir el editor
3.1 pasar el npm install
3.2 npm run lint:fix
3.3 npm run format
3.4 npm run build.

4 La logica de los componetes tiene que ir separada en su archivo correspondiente, con un nopmbre descriptivo y adecuado.
