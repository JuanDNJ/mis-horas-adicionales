...
import { a as h, i as g, o as _ } from "./index-D4OOz8tB.js";
var v = p(),
  y = c();
const b = () => {
  let e = (0, v.c)(5),
  ...
  return (
    e[3] === r
      ? (i = e[4])
      : ((i = (0, y.jsxs)(`nav`, {
          className: `hidden xl:flex justify-center gap-8 items-center absolute left-1/2 -translate-x-1/2`,
          children: [n, r],
        })),
        (e[3] = r),
        (e[4] = i)),
...
const w = (e) => {
  let t = (0, C.c)(26),
    { isOpen: n, onClose: r } = e,
    { isAuthenticated: i } = h(),
    a = n ? `opacity-100 pointer-events-auto` : `opacity-0 pointer-events-none`,
    o;
  t[0] === a
    ? (o = t[1])
    : ((o = x(`fixed inset-0 bg-black/50 z-40 xl:hidden transition-opacity duration-300`, a)),
      (t[0] = a),
      (t[1] = o));
  let s;
  t[2] !== r || t[3] !== o
    ? ((s = (0, y.jsx)(`article`, { className: o, onClick: r })),
      (t[2] = r),
      (t[3] = o),
      (t[4] = s))
    : (s = t[4]);
  let c = n ? `translate-x-0` : `-translate-x-full`,
    l;
  t[5] === c
    ? (l = t[6])
    : ((l = x(
  ...
  let v;
  t[16] !== _ || t[17] !== g
    ? ((v = (0, y.jsxs)(`nav`, { className: `flex flex-col p-4 gap-4`, children: [g, _] })),
      (t[16] = _),
      (t[17] = g),
      (t[18] = v))
    : (v = t[18]);
  let b;
  t[19] !== v || t[20] !== l || t[21] !== m
    ? ((b = (0, y.jsxs)(`section`, { className: l, children: [m, v] })),
      (t[19] = v),
      (t[20] = l),
      (t[21] = m),
      (t[22] = b))
  ...
  return (
    t[23] !== b || t[24] !== s
      ? ((S = (0, y.jsxs)(y.Fragment, { children: [s, b] })), (t[23] = b), (t[24] = s), (t[25] = S))
      : (S = t[25]),
    S
  );
};
...
const D = (e) => {
  let t = (0, T.c)(37),
    { label: n, options: r, value: a, onChange: o, renderItem: s, className: c } = e,
    [l, u] = (0, E.useState)(!1),
    d = (0, E.useRef)(null),
    f,
    p;
  (t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    (0, E.useEffect)(f, p));
  let m;
  t[2] === c ? (m = t[3]) : ((m = x(`w-full max-w-xs space-y-3`, c)), (t[2] = c), (t[3] = m));
  let h;
  t[4] === n
    ? (h = t[5])
    : ((h =
      ...
      (t[5] = h));
  let g;
  t[6] === l ? (g = t[7]) : ((g = () => u(!l)), (t[6] = l), (t[7] = g));
  let _ = l && `ring-2 ring-theme-color/20 border-theme-color`,
    v;
  t[8] === _
    ? (v = t[9])
    : ((v = x(
  ...
  t[10] !== s || t[11] !== a
    ? ((b = s
        ? s(a, !0)
        : (0, y.jsx)(`span`, { className: `font-medium text-theme-color`, children: a.name })),
      (t[10] = s),
      (t[11] = a),
      (t[12] = b))
    : (b = t[12]);
  ...
  t[13] === b
    ? (S = t[14])
    : ((S = (0, y.jsx)(`div`, { className: `flex items-center gap-1 md:gap-3`, children: b })),
      (t[13] = b),
      (t[14] = S));
  let C = l && `rotate-180`,
    w;
  t[15] === C
    ? (w = t[16])
    : ((w = x(`text-secondary transition-transform duration-200 ml-1 md:ml-3`, C)),
      (t[15] = C),
      (t[16] = w));
  let D;
  t[17] === w ? (D = t[18]) : ((D = (0, y.jsx)(i, { className: w })), (t[17] = w), (t[18] = D));
  let O;
  t[19] !== D || t[20] !== g || t[21] !== v || t[22] !== S
    ? ((O = (0, y.jsxs)(`button`, { type: `button`, onClick: g, className: v, children: [S, D] })),
      (t[19] = D),
      (t[20] = g),
      (t[21] = v),
      (t[22] = S),
    ...
    : (O = t[23]);
  let k;
  t[24] !== l || t[25] !== o || t[26] !== r || t[27] !== s || t[28] !== a
    ? ((k =
        l &&
        (0, y.jsx)(`div`, {
                ...
                children: [
                  s
                    ...
                    : (0, y.jsx)(`span`, {
                        className: x(
                          `flex-1 font-medium`,
                          a.id === e.id ? `text-option-selected` : `text-secondary`
                        ),
                        children: e.name,
                      }),
                  a.id === e.id &&
  ...
  let A;
  t[30] !== O || t[31] !== k
    ? ((A = (0, y.jsxs)(`div`, { className: `relative`, children: [O, k] })),
      (t[30] = O),
      (t[31] = k),
      (t[32] = A))
    : (A = t[32]);
  ...
  return (
    t[33] !== A || t[34] !== m || t[35] !== h
      ? ((j = (0, y.jsxs)(`div`, { className: m, ref: d, children: [h, A] })),
        (t[33] = A),
        (t[34] = m),
        (t[35] = h),
        (t[36] = j))
...
const k = (e) => {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, y.jsx)(n, { className: `text-lg` })),
      (u = (0, y.jsx)(`span`, { children: `Cerrar Sesión` })),
      (t[5] = l),
      (t[6] = u))
    : ((l = t[5]), (u = t[6]));
  let d;
  return (
    t[7] !== s || t[8] !== c
      ? ((d = (0, y.jsxs)(`button`, { onClick: s, className: c, children: [l, u] })),
        (t[7] = s),
        (t[8] = c),
        (t[9] = d))
      : (d = t[9]),
...
const j = (t) => {
    let n = (0, A.c)(23),
      { className: r } = t,
      { isAuthenticated: i, photoURL: a, displayName: c, email: l } = h(),
      [u, d] = (0, E.useState)(!1),
      f = (0, E.useRef)(null),
      p,
      m;
    if (
      ...
      return null;
    let g;
    n[2] === r ? (g = n[3]) : ((g = x(`relative`, r)), (n[2] = r), (n[3] = g));
    let _;
    n[4] === u ? (_ = n[5]) : ((_ = () => d(!u)), (n[4] = u), (n[5] = _));
    let v = u && `ring-2 ring-theme-color/20`,
      b;
    n[6] === v
      ? (b = n[7])
      : ((b = x(
    ...
    n[8] !== c || n[9] !== a
      ? ((S = a
          ...
          : (0, y.jsx)(o, { className: `text-2xl md:text-3xl text-theme-color` })),
        (n[8] = c),
        (n[9] = a),
        (n[10] = S))
      : (S = n[10]);
    let C;
    n[11] !== _ || n[12] !== b || n[13] !== S
      ? ((C = (0, y.jsx)(`button`, {
          type: `button`,
          onClick: _,
          className: b,
          ...
          (0, y.jsxs)(`article`, {
            ...
            children: [
              (0, y.jsxs)(`div`, {
                ...
                children: [
                  (0, y.jsx)(`p`, {
                    className: `text-sm font-bold text-theme-color truncate`,
                    children: c || `Usuario`,
                  }),
                  (0, y.jsx)(`p`, { className: `text-xs text-secondary truncate`, children: l }),
                ],
              }),
              (0, y.jsxs)(e, {
                to: `/profile`,
                ...
                children: [
                  (0, y.jsx)(s, { className: `text-lg` }),
                  (0, y.jsx)(`span`, { children: `Perfil` }),
                ],
              }),
              (0, y.jsx)(k, { onAction: () => d(!1) }),
            ],
          })),
        (n[15] = c),
        (n[16] = l),
    ...
    let T;
    return (
      n[19] !== g || n[20] !== C || n[21] !== w
        ? ((T = (0, y.jsxs)(`section`, { className: g, ref: f, children: [C, w] })),
          (n[19] = g),
          (n[20] = C),
          (n[21] = w),
          (n[22] = T))
...
var N = p(),
  P = () => {
    let e = (0, N.c)(5),
      { selectedTheme: t, setSelectedTheme: n } = M(),
      r;
    e[0] === n
      ? (r = e[1])
      : ((r = (e) => {
    ...
    return (
      e[2] !== i || e[3] !== t
        ? ((a = { selectedTheme: t, onChangeTheme: i, themes: g }),
          (e[2] = i),
          (e[3] = t),
          (e[4] = a))
        : (a = e[4]),
...
const I = () => {
  let e = (0, F.c)(7),
    { selectedTheme: t, onChangeTheme: n, themes: r } = P(),
    i;
  e[0] !== n || e[1] !== t || e[2] !== r
    ? ((i = (0, y.jsx)(D, {
        options: r,
...
function L(e, t) {
  return (0, y.jsxs)(y.Fragment, {
    children: [
      (0, y.jsx)(e.icon, { className: x(`text-lg md:text-xl`, e.color) }),
      (0, y.jsx)(`span`, {
        className: x(
...
const V = (e) => {
  ...
  t[0] === a
    ? (c = t[1])
    : ((c = x(`flex items-center gap-2 md:gap-4`, a)), (t[0] = a), (t[1] = c));
  let l;
  t[2] === o ? (l = t[3]) : ((l = x(`text-theme-color`, o)), (t[2] = o), (t[3] = l));
  let u;
  t[4] !== s || t[5] !== l || t[6] !== r
    ? ((u = (0, y.jsx)(s, { className: l, children: r })),
      (t[4] = s),
      (t[5] = l),
      (t[6] = r),
      (t[7] = u))
  ...
  return (
    t[8] !== i || t[9] !== c || t[10] !== u
      ? ((d = (0, y.jsxs)(`article`, { className: c, children: [i, u] })),
        (t[8] = i),
        (t[9] = c),
        (t[10] = u),
        (t[11] = d))
...
const G = (e) => {
  let t = (0, W.c)(5),
    ...
    r;
  t[0] === n ? (r = t[1]) : ((r = (0, y.jsx)(z, { onClick: n })), (t[0] = n), (t[1] = r));
  let i;
...
const q = () => {
  let e = (0, K.c)(4),
    ...
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((n = (0, y.jsx)(l, { className: `text-lg md:text-xl` })),
      (r = (0, y.jsx)(`span`, { children: `Acceder` })),
      (e[0] = n),
      (e[1] = r))
    : ((n = e[0]), (r = e[1]));
  let i;
...
var J = p(),
  Y = () => {
    let e = (0, J.c)(13),
      ...
      a;
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, y.jsx)(G, { onOpenMobileMenu: () => n(!0) })),
        (a = (0, y.jsx)(b, {})),
        (e[0] = i),
        (e[1] = a))
      : ((i = e[0]), (a = e[1]));
    ...
    e[2] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (o = e[2]);
    let s;
    e[3] === r ? (s = e[4]) : ((s = !r && (0, y.jsx)(q, {})), (e[3] = r), (e[4] = s));
    let c;
    e[5] === s
      ? (c = e[6])
      : ((c = (0, y.jsxs)(`div`, {
        ...
        (e[6] = c));
    let l;
    e[7] === Symbol.for(`react.memo_cache_sentinel`) ? ((l = () => n(!1)), (e[7] = l)) : (l = e[7]);
    let u;
    e[8] === t
      ? (u = e[9])
      : ((u = (0, y.jsx)(w, { isOpen: t, onClose: l })), (e[8] = t), (e[9] = u));
    let d;
    return (
      e[10] !== c || e[11] !== u
        ? ((d = (0, y.jsxs)(`header`, {
  ...
  Z = (e) => {
    ...
    return (
      t[0] === n
        ? (r = t[1])
        : ((r = (0, y.jsx)(`main`, { className: `flex flex-col overflow-x-hidden`, children: n })),
          (t[0] = n),
          (t[1] = r)),
      r
    );
  };
export { x as a, S as i, Y as n, M as r, Z as t };
