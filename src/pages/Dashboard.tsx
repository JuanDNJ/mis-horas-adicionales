      ...
      <Main>
        <div className="w-full flex flex-col py-8 px-4">
          ...
          <div className="flex flex-col xl:flex-row items-start justify-center w-full gap-8">
            ...
            {isFormOpen && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 xl:static xl:z-auto xl:bg-transparent xl:p-0 xl:backdrop-blur-none xl:flex-col xl:w-auto xl:min-w-[450px] animate-in fade-in duration-200 xl:slide-in-from-left">
                ...
                <div className="w-full max-h-[90vh] overflow-y-auto no-scrollbar xl:overflow-visible xl:max-h-none flex flex-col items-center gap-6 xl:gap-0">
                  ...
                  <div className="w-full flex justify-end xl:hidden sticky top-0 z-10 mb-2">
                    <button
                      ...
                      className="bg-red-500 text-white p-2 border-2 border-black shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] active:translate-y-[2px] active:shadow-none transition-all"
                    >
                      <FaTimes size={24} />
                    </button>
                  </div>
